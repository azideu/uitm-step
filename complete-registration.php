...
<div class="max-w-md mx-auto bg-white dark:bg-slate-900 p-8 rounded-lg shadow-xl border border-gray-100 dark:border-slate-800 transition-colors duration-300 mt-10 animate-fade-in-up">
