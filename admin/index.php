                    ...
                    <div class="flex flex-col lg:flex-row lg:items-start gap-5">
                                ...
                                <form action="report_action" method="POST" class="bg-gray-50 dark:bg-slate-800/60 rounded-2xl p-4 border border-gray-100 dark:border-slate-700 space-y-3"
                                    ...
                                    <div class="grid grid-cols-1 gap-2">
                                        <button type="submit" name="action" value="reviewed"
                                                class="w-full py-2 rounded-xl bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-800/50 text-xs font-bold hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-all duration-200">
                                            ✅ Mark Reviewed
                                        </button>
                                        <button type="submit" name="action" value="dismissed"
                                                class="w-full py-2 rounded-xl bg-gray-100 dark:bg-slate-700 text-gray-600 dark:text-slate-300 border border-gray-200 dark:border-slate-600 text-xs font-bold hover:bg-gray-200 dark:hover:bg-slate-600 transition-all duration-200">
                                            ❌ Dismiss Report
                                        </button>
                                        <?php if ($rep['reported_role'] !== 'banned'): ?>
                                            <button type="submit" name="action" value="banned"
                                                    class="w-full py-2 rounded-xl bg-red-600 hover:bg-red-700 text-white text-xs font-bold shadow transition-all duration-200">
                                                🚫 Ban User
                                            </button>
                                        <?php else: ?>
                                            <div class="w-full py-2 rounded-xl bg-rose-900/20 text-rose-400 text-xs font-bold text-center border border-rose-800/50">
                                                User Already Banned
                                            </div>
                                        <?php endif; ?>
                                    </div>
                        ...
                        <?php else: ?>
                            <div class="lg:w-64 flex-shrink-0 flex items-center justify-center">
                                <div class="bg-rose-50 dark:bg-rose-900/20 border border-rose-200 dark:border-rose-800/50 rounded-2xl p-4 text-center">
                                    <span class="text-2xl">🚫</span>
                                    <p class="text-xs font-bold text-rose-700 dark:text-rose-300 mt-2">User Banned</p>
                                    <p class="text-xs text-rose-500 dark:text-rose-400 mt-1">No further action required.</p>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
