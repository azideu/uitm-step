    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-grow bg-white dark:bg-slate-900 rounded-3xl shadow-xl border border-gray-100 dark:border-slate-800 overflow-hidden transition-colors duration-300">
            ...
            <div class="p-8 md:p-12">
                ...
                <!-- Hero Visual Block -->
                <div class="w-full h-48 bg-gradient-to-br from-uitmPurple via-[#26004d] to-indigo-955 rounded-2xl flex items-center justify-center mb-10 shadow-md relative overflow-hidden">
                    <div class="absolute inset-0 bg-noise opacity-10 mix-blend-overlay"></div>
                    <div class="border-2 border-white/20 rounded-xl p-8 bg-white/5 backdrop-blur-sm text-center">
                ...
                <div class="prose prose-slate dark:prose-invert max-w-none">
                    <p class="text-lg text-slate-700 dark:text-slate-350 mb-6 leading-relaxed">
