    ...
    <footer class="bg-white dark:bg-slate-950 text-slate-600 dark:text-slate-400 py-12 mt-auto border-t border-slate-200 dark:border-slate-800/60 shadow-[inset_0_1px_0_0_rgba(0,0,0,0.05)] dark:shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)] relative overflow-hidden transition-colors duration-300">
        <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom,_var(--tw-gradient-stops))] from-uitmPurple/5 dark:from-uitmPurple/10 via-transparent to-transparent pointer-events-none"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8 mb-12">
                <div class="md:col-span-2">
                    ...
                    <p class="text-slate-500 dark:text-slate-400 mb-6 max-w-sm text-sm leading-relaxed">
                        The premier freelance marketplace built exclusively for UiTM students. Discover talent, build your portfolio, and elevate your academic journey.
                    </p>
                </div>
                <div>
                    ...
                    <ul class="space-y-3 text-sm">
                        ...
                        <li><a href="feedback.php"class="hover:text-uitmPurple dark:hover:text-uitmGold transition-colors flex items-center group"><span class="w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-slate-700 group-hover:bg-uitmPurple dark:group-hover:bg-uitmGold mr-2 transition-colors"></span> Feedback and Support</a></li>
                        <li><a href="faq.php"class="hover:text-uitmPurple dark:hover:text-uitmGold transition-colors flex items-center group"><span class="w-1.5 h-1.5 rounded-full bg-slate-300 dark:bg-slate-700 group-hover:bg-uitmPurple dark:group-hover:bg-uitmGold mr-2 transition-colors"></span> Frequently Asked Questions</a></li>
                </div>
                <div>
                    <h3 class="text-slate-900 dark:text-white font-bold mb-5 uppercase tracking-widest text-xs">Connect</h3>
                    <ul class="space-y-3 text-sm">
                        <li>
                            <a href="https://github.com/azideu/uitm-step" target="_blank" rel="noopener noreferrer" class="hover:text-slate-900 dark:hover:text-white transition-colors flex items-center group">
                        ...
                        <li>
                            <a href="https://uitm.edu.my" target="_blank" rel="noopener noreferrer" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors flex items-center group">
                                <svg class="w-5 h-5 mr-3 text-slate-400 dark:text-slate-500 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9"></path></svg>
                                UiTM Website
                            </a>
                        </li>
                        <li>
                            <a href="https://twitter.com/uitmofficial" target="_blank" rel="noopener noreferrer" class="hover:text-sky-500 dark:hover:text-sky-400 transition-colors flex items-center group">
                        ...
                        <li>
                            <a href="https://www.instagram.com/uitm.official/" target="_blank" rel="noopener noreferrer" class="hover:text-pink-600 dark:hover:text-pink-500 transition-colors flex items-center group">
